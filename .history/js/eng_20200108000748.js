...
window.onload = function () {
    ...
    document.getElementById('game-contents-1').innerHTML = 'Powstały one w VI w. n.e. w Indiach. Do Europy trafiły w okolicach VIII/IX w. i osiadły tam na dobre. Na ich fenomen trzeba było jeszcze wtedy sporo poczekać bo aż do XVI w. Wtedy to wprowadzono kilka istotnych zmian w rozgrywce, które uatrakcyjniły całość i przyczniły się do popularyzacji tejże gry.';

    document.getElementById('game-title-2').innerHTML = 'Scrable';
    document.getElementById('game-contents-2').innerHTML = ' Gra ta została wynaleziona przez architekta Alfreda Buttsa w 1931r., chociaż zaczęto ją sprzedawać dopiero w roku 1946. Polega ona na losowaniu płytek z literami i układaniu ich na planszy w słowa. Z czasem gra zaczęła coraz bardziej zyskiwać na popularności, w wyniku czego na całym świecie sprzedano ponad 100 mln egzemplarzy.';
