...
pl.addEventListener("click", function() {
  ...
  setTimeout(function() {
    ...
    document.getElementById("top-text").innerHTML =
      "Poznaj historie gier planszowych i odkryj te, których jeszcze nie znałeś";
    ...
    document.getElementById("history-title-article-3").innerHTML =
      "Jednak nie pierwsza?";
    ...
    document.getElementById("game-contents-4").innerHTML =
      "To klasyczna gra planszowa, która polega na handlu nieruchomościami, gdzie gracze okrążają planszę, kupując i sprzedając nieruchomości, budując domy i hotele, a sukces zależy od trafnych spekulacji, udanych inwestycji i mądrze przeprowadzonych transakcji.";
    ...
    document.getElementById("bottom-text-1").innerHTML =
      'Projekt współfinansowany z Europejskiego Funduszu "Ciekawe skąd wziął na to pieniązki"';
