...
en.addEventListener("click", function() {
  ...
  setTimeout(function() {
    ...
    document.getElementById("history-contents-article-1").innerHTML =
      "The oldest elements of board games are over 5000 years old. It is a series of 49 small carved painted stones which was found in southeast Turkey. Similar pieces have been found in Syria and Iraq and seem to point to board games having originated in the Fertile Crescent.";

    document.getElementById("history-title-article-2").innerHTML =
      "First game?";
    document.getElementById("history-contents-article-2").innerHTML =
      "Many researchers think that one of the first board games was dice. That game has changed for ages. Not only was it made of bones but also of teeth, antlers and tusks. Since ancient times people had looked for godlike element in it. In Rome they believed that Lady Luck, Fortuna can move the needle on results. People often accept a roll of the dice clearly reflect Gods volition.";
    ...
    document.getElementById("game-contents-5").innerHTML =
      "Rummikub is a tile-based game for two to 4 players, combining elements of the card game rummy and mahjong. There are 104 number tiles in the game (valued 1 to 13 in four different colors, two copies of each) and two jokers. Players have 14 or 16 tiles initially and take turns putting down tiles from their racks into sets (groups or runs) of at least three, drawing a tile if they cannot play.";
    ...
    document.getElementById("curiosities-contents-1").innerHTML =
      "The Guinness World record for the longest board marathon in history lasted as many as 61 hours and 2 minutes!";
    document.getElementById("curiosities-contents-2").innerHTML =
      "The most expensive game sold is the Jewel Royale chess set, made of gold and platinum. It was sold for 9.8 million dollars!";
    document.getElementById("curiosities-contents-3").innerHTML =
      "On November 30, 2016, the Dutch created the world's largest Monopoly game board! Its surface is up to 900 m²";
    document.getElementById("curiosities-contents-4").innerHTML =
      "One of the people who created the most board games is Dr. Reiner Knizia. He is the author of over 200 board games! He designed his first game when he was 8 years old.";
    document.getElementById("curiosities-contents-5").innerHTML =
      "In 1924, the International Chess Federation was established in Paris. The first Chess Olympiad dates from the same year.";

    // ####-SECTION-QUIZ-####

    document.getElementById("quiz-title").innerHTML =
      "Check your knowledge! <br> Take part in a quiz of 20 questions.";
    document.getElementById("quiz-button").innerHTML = "Ok, let's try!";

    // ####-SECTION-GO-GAME-####

    document.getElementById("go-game-contents").innerHTML =
      "Hungry for board games? <br> You say, and you have! <br> We invite you to our store, <br> where you can get different games";
    ...
    document.getElementById("footer-text").innerHTML =
      "&copy; 2019 zszarki.pl All rights reserved";
